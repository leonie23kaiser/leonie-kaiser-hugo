...
## For Service/Agency Sites (like integrations.at)

High-value programmatic patterns:
- **Persona pages:** `/for/logistics-companies/`, `/for/manufacturing/`, `/for/retail/`
- **Integration pages:** `/integrations/sap/`, `/integrations/microsoft-365/`, `/integrations/salesforce/`
- **Comparison pages:** `/compare/mulesoft-vs-boomi/`, `/compare/zapier-vs-make/`
- **Location pages:** `/services/vienna/`, `/services/graz/` (only if you have real local presence/data)
