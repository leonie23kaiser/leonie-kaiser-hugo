...
```json
{
  ...
  "logo": "https://integrations.at/images/logo.png",
  "description": "Software integration experts specializing in Microsoft, SAP, and custom API integrations.",
  "foundingDate": "2020",
  "address": {
    "@type": "PostalAddress",
  ...
  "contactPoint": {
    ...
    "email": "hello@integrations.at"
  },
  "sameAs": [
    "https://linkedin.com/company/integrations-at",
    "https://github.com/integrations-at"
  ]
}
```
...
```json
{
  ...
  "publisher": {
    ...
    "logo": {
      "@type": "ImageObject",
      "url": "https://integrations.at/images/logo.png",
      "width": 600,
      "height": 60
    }
  },
  ...
  "itemListElement": [
    {
      ...
      "position": 1,
      "name": "Home",
      "item": "https://integrations.at/"
    },
    {
      "@type": "ListItem",
      "position": 2,
      "name": "Agentic AI",
      "item": "https://integrations.at/agentic-ai/"
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "AI Integration Services",
      "item": "https://integrations.at/agentic-ai/ai-integration/"
    }
  ]
}
```
