...
description: "Ein optimiertes Google Unternehmensprofil als Grundlage: So werden kleine Gesundheitspraxen bei Google und in KI-Suchen wie ChatGPT gefunden."
date: 2026-09-22
lastmod: 2026-09-22
...
Eine Physiotherapie-Praxis hat freie Kapazität für neue Kundschaft, trotzdem bleibt der Kalender an manchen Tagen halbleer. Sucht jemand in der Nähe nach einem Termin, taucht die Praxis auf der Google-Ergebnisseite kaum auf. Das Google-Profil zeigt noch die alte Adresse und ein Angebot, das es seit einem Jahr nicht mehr gibt. Fragt dieselbe Person stattdessen ChatGPT nach einer Empfehlung, landet die Praxis dort ebenfalls nicht, aus demselben Grund.

Google zeigt bei vielen Suchen heute selbst schon eine KI-generierte Zusammenfassung über den klassischen Ergebnissen, direkt am oberen Rand der Seite. Wer dort erwähnt wird, gilt als gefunden, ganz ohne Klick auf die eigene Website. Und fragt jemand ChatGPT oder Perplexity nach einer Physiotherapie-Praxis in der Nähe, durchsucht die KI ähnliche Quellen wie eine klassische Suche: das Google-Profil, den Inhalt der eigenen Website, Bewertungen. Beide Kanäle stützen sich auf dieselbe Grundlage. Deshalb gehören sie in diesen einen Beitrag, nicht weil es zwei getrennte Trends wären, sondern weil dieselbe Grundarbeit für beide zählt.

Wie wichtig das inzwischen ist, zeigt eine Analyse von SparkToro und Datos: Anfang 2026 endeten rund 68 Prozent der Google-Suchen in den USA ganz ohne Klick auf eine Website, bei Suchen mit einer KI-Zusammenfassung lag die Klickrate sogar rund 60 Prozent niedriger als sonst (Search Engine Land, 2026). Die Zahlen stammen aus den USA, der Trend zeichnet sich hierzulande aber ähnlich ab. Wer schon in meinem Beitrag <a href="/blog/praxis-haengt-an-der-leitung/">„Ohne mich läuft hier nichts"</a> gelesen hat, wie stark eine Praxis von Mundpropaganda und einer einzelnen Person abhängen kann, erkennt hier ein verwandtes Muster: Wer online nicht auffindbar ist, bleibt auf genau diese Mundpropaganda angewiesen.

## Warum Google-Suche und KI-Assistenten zusammengehören
...
<div class="highlight-box">
  ...
  <ul style="margin-top:var(--s3);margin-bottom:0">
    ...
    <li>Öffnungszeiten: aktuell und mit dem Google-Profil abgeglichen</li>
...
1. Google-Profil und Website nebeneinander öffnen, dann Adresse, Öffnungszeiten, Angebot und Telefonnummer vergleichen.
...
Nicht, wenn am Ende ein Mensch gegenliest und in die eigene Sprache überträgt. KI kann beim ersten Entwurf helfen, gelesen und freigegeben wird der Text aber immer von jemandem aus der Praxis.
...
Wenn Sie das Gefühl kennen, dass Ihre Praxis online eigentlich mehr zu bieten hätte, als bei Google oder in einer KI-Suche sichtbar wird, schauen wir uns das gern in einer kostenfreien Potenzialanalyse an: wo Ihre Praxis bei der Digitalisierung steht, welche Ziele Sie haben und wo aktuell die größten Engpässe liegen.
