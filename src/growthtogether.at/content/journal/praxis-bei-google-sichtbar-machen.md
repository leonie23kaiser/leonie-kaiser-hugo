...
Bei manchen Suchanfragen zeigt Google zusätzlich zu den klassischen Treffern eine KI-generierte Zusammenfassung. Ob und wie diese erscheint, hängt unter anderem von Suchanfrage, Standort, Sprache und der aktuellen Darstellung der Suchergebnisse ab. Bei Suchanfragen mit Ortsbezug erscheint häufig außerdem eine Kartenansicht mit mehreren lokalen Ergebnissen, oft als „Local Pack" bezeichnet. Welche Praxen dort erscheinen, hängt unter anderem davon ab, wie gut das Angebot zur Suche passt, wie nah die Praxis liegt und wie vollständig und bekannt ihre Online-Präsenz ist.

Auch KI-gestützte Suchsysteme brauchen klare, öffentlich auffindbare Informationen. Je nach System und Anfrage werden unterschiedliche Webquellen genutzt. Eine vollständige Website, konsistente Standortdaten, aktuelle Profile und nachvollziehbare Leistungsbeschreibungen erhöhen die Chance, dass eine Praxis bei passenden Fragen überhaupt erkannt und eingeordnet werden kann.
...
Ein häufig übersehener Fall: Nach einem Umzug oder einer Umbenennung bleibt manchmal ein zweites, veraltetes Profil parallel bestehen. Das kann dazu führen, dass Interessierte widersprüchliche Angaben sehen oder bei der Suche an der falschen Adresse landen. Solche Duplikate sollten geprüft, zusammengeführt oder, sofern möglich, dauerhaft geschlossen werden.

Prüfen Sie das Profil mindestens einmal im Quartal vollständig. Ändern sich Öffnungszeiten, Standort, Telefonnummer oder Leistungen, aktualisieren Sie die Angaben sofort. Neue Fragen und Bewertungen behalten Sie am besten zeitnah im Blick.
...
<div class="highlight-box">
  ...
  <ul style="margin-top:var(--s3);margin-bottom:0">
    <li>Angebot: welche Leistungen, in eigenen Worten beschrieben</li>
    <li>Einzugsgebiet: Ort und Umgebung, für die die Praxis erreichbar ist</li>
    <li>Schwerpunkte: worauf sich die Praxis spezialisiert</li>
    <li>Öffnungszeiten: aktuell und mit dem Google-Unternehmensprofil abgeglichen</li>
    <li>Kontaktwege: Telefon, E-Mail, Online-Formular, jeweils mit direktem Link</li>
  </ul>
</div>

## Regelmäßige Inhalte, die nach Ihnen klingen

Je regelmäßiger neue Inhalte entstehen, desto häufiger arbeiten unterschiedliche Personen aus dem Team daran mit. Das ist sinnvoll, denn das praktische Fachwissen liegt bei den Menschen im Team. Ein kurzer, schriftlich festgehaltener Rahmen sorgt trotzdem für eine einheitliche Stimme: Sie-Form, keine Fachbegriffe ohne Erklärung und ein Beispiel pro Text, dazu wer vor der Veröffentlichung noch einmal gegenliest.

Ein leeres Dokument kann Teams davon abhalten, regelmäßig Inhalte für die Website zu erstellen, nicht fehlende Ideen. Ideen liegen meist schon vor: häufig gestellte Fragen an der Rezeption, eine neue Leistung sowie saisonale Themen, etwa zu Rückenschmerzen im Homeoffice. Eine feste Vorlage für Struktur und Länge nimmt die eigentliche Hürde: Inhalte nicht jedes Mal von Grund auf neu konzipieren zu müssen. Für die Physiotherapie-Praxis aus dem Einstieg reicht eine Vorlage mit drei Fragen: Welches Problem hatte die Person, was wurde gemacht, was hat sich verändert. Daraus kann ein kurzer Beitrag entstehen, ohne dass das Team jedes Mal über Aufbau und Ton neu entscheiden muss. Für den Anfang genügt ein Rhythmus, den Ihr Team zuverlässig durchhalten kann, etwa alle zwei bis vier Wochen ein kurzer Beitrag. Wichtiger als die genaue Frequenz sind nützliche Inhalte, Aktualität und ein Ablauf, der langfristig in den Praxisalltag passt.
...
**Reicht ein gepflegtes Google-Unternehmensprofil allein?**
...
Nein, ich biete keinen laufenden Service zur regelmäßigen Content-Erstellung an. Unterstützen kann ich bei der Strategie, der Themenplanung, den Vorlagen, redaktionellen Leitlinien, der Optimierung der Website selbst und dabei, das Team für das laufende Schreiben zu befähigen. Das laufende Schreiben liegt danach im Team, weil dort das Praxiswissen liegt.

**Merkt man Texten an, dass sie mit KI erstellt wurden?**
Nicht, wenn am Ende ein Mensch gegenliest und in die eigene Sprache überträgt. KI kann beim ersten Entwurf helfen, gelesen und freigegeben wird der Text aber immer von jemandem aus der Praxis. Dabei unterstütze ich auch bei einer gemeinsam festgelegten sprachlichen Leitlinie für Ton, Wortwahl, Satzlänge und Ansprache, damit auch KI-unterstützte Texte zur Praxis passen.

**Wer pflegt die Inhalte ein, wenn sie fertig sind?**
Das Team selbst, sobald die erste Vorlage und ein fester Ablauf stehen. Bei der Einrichtung dieses Ablaufs unterstütze ich Sie gerne, mehr dazu auf meiner Seite <a href="/leistungen/sichtbarkeit-und-inhalte/">Sichtbarkeit & Inhalte</a>.
