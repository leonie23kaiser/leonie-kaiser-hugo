...
*(Bewusst als **Ziel/Vision** formuliert – behauptet keine Kundenfälle, die es noch nicht gibt.)*

## Farbpalette (für Canva, max. 5 Farben)

| # | Hex | Name | Verwendung |
|---|---|---|---|
| 1 | `#086584` | Teal (Primär) | Buttons, Links, Überschriften-Akzent |
| 2 | `#5FA2A0` | Teal hell | Sekundär, Verläufe, Hover |
| 3 | `#530049` | Violett (tief) | Akzent, Eyebrows, Hero-Ton |
| 4 | `#CF982B` | Gold | Labels, sparsame Highlights |
| 5 | `#FAF0E9` | Beige | Heller Hintergrund |

- **Textfarbe (Neutral):** `#1D2228` (fast-schwarz) – falls Canva einen 6. Slot erlaubt.
- Website-Basisviolett ist eigentlich `#6B2C8C`; fürs neue Hero-Bild wurde das tiefere
  `#530049` verwendet. Für Canva `#530049` empfohlen (passt zum aktuellen Hero).
